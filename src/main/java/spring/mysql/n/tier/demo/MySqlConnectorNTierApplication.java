package spring.mysql.n.tier.demo;

import org.springframework.context.support.AbstractApplicationContext;
import org.springframework.context.support.ClassPathXmlApplicationContext;

import spring.mysql.n.tier.demo.controllers.WorkerController;
...
public class MySqlConnectorNTierApplication {
	...
	public static void main(String[] args) {
		...
		System.out.println("Updating the salary of all workers in R&D department");
		System.out.println(workerController.updateBySalary("R&D", 1) + "\n");
